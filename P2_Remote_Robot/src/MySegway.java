 ...
 *
 */
public class MySegway extends Thread { // TODO: Thread should be a private inner class.

	//-----our modification-------
	
//	private static final int interval = 5;
//	public static final int ARRAY_LENGTH = 30*1000/interval;
//	public int[][] y_array = new int[2][ARRAY_LENGTH];
//	int y_index = 0;
...
//	private double gOffset;
	 ...
	 */
	public MySegway(EncoderMotor left, EncoderMotor right, GyroSensor gyro, double wheelDiameter) {
...
//		if(y_index < this.ARRAY_LENGTH){
//		if(y_index!=0){
//		y_array[0][y_index] = Math.round(System.currentTimeMillis() - tCalcStart);
//		}else{	
//			y_array[0][y_index]=0;
//		}
//		y_array[1][y_index] = Math.round(gyroRaw);
//		y_index++;
//		}
